...
export function div(props: NaElementProps, children: ReadonlyArray<NaNode | Cell<NaNode>>): NaElement;
export function div(children: ReadonlyArray<NaNode | Cell<NaNode>>): NaElement;
