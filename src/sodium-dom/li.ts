...
export function li(props: NaElementProps, children: ReadonlyArray<NaNode | Cell<NaNode>>): NaElement;
export function li(children: ReadonlyArray<NaNode | Cell<NaNode>>): NaElement;
